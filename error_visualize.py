...
for i in range(len(image_num_list)):
    ...
    # 一方の画像
    #image_path_1 = Path.cwd() / "./fox/val/{}.jpg".format(image_num)
    image_path_1 = Path.cwd() / "/home/ito/kaolin-wisp/_results/logs/runs/test-ngp-nerf/20221103-004724/val/{}-{}-lod15.png".format(image_num,val_num)
    # 他方の画像（比較画像を想定）
    image_path_2 = Path.cwd() / "/home/ito/kaolin-wisp/_results/logs/runs/test-ngp-nerf/20221103-145343/val/{}-{}-lod15.png".format(image_num,val_num)
